/* index.html / style.css / config.js / normalize.js / compose.js / storage.js / app.js を
   1つの HTML に まとめて gas/Index.html を つくります
   （Apps Script は 外部ファイルを よみこめないため）。
...
const parts = [
  ...
  ['<script src="normalize.js"></script>',     () => `<script>\n${read('normalize.js')}\n</script>`],
  ['<script src="compose.js"></script>',       () => `<script>\n${read('compose.js')}\n</script>`],
